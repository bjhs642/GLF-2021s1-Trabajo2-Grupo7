...
/** -------------------------- **/
import { AFN } from './AFNtoAFD.js';
import { simplificar } from './simplificar';
import { controladora } from './union.js';
...
let automata_2 = [];
let estadosNoAceptadores_A2 = [];
let estadosAceptadores_A2 = []; //Estado final
let tipoDeAutomata_2;
...
let finalizoAutomata = false; //Cuando finalice automata 2
/** --------------o----------------- **/
...
function funciones(automata_1, automata_2, tipoDeAutomata_1, tipoDeAutomata_2, estadosAceptadores_A1, estadosAceptadores_A2) {
  //Ingreso los datos correctamente
  //Si es un automata AFN proceder a su transformación
  // 0: AFD | 1: AFND
  //----------
  console.log("Entre a funciones")
  let afdTransformado_1 = [], afdTransformado_2 = [];
  console.log("Tipo de au 1: ", parseInt(tipoDeAutomata_1));
  console.log("Tipo de au 2: ", parseInt(tipoDeAutomata_2));

  if (parseInt(tipoDeAutomata_1) === 1 && parseInt(tipoDeAutomata_2) === 1){
    //Los dos son AFND
...
window.onload = async ()=>{
  ...
  var botonGuardaAutomata2 = document.getElementById("finalizara2");
